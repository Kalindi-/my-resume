...
var bio = {
    ...
    "skills" : [
        ...
        "motivation and concentration to do tasks",
        "inventive with the aim to improve"
        ],
    ...
    "countries" : [

        {
            ...
            [
                ...
                { "city_name" : "grobnik, rijeka", "coordinates" : [45.3682175, 14.4575225, 'grobnik, rijeka']},
                { "city_name" : "motovun", "coordinates" : [45.3359506, 13.8278605, 'motovun']},
                { "city_name" : "krknata, zaglav", "coordinates" : [43.9661794, 15.1390528, 'krknata, zaglav']},
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "log pri brezovici", "coordinates" : [46.0082081, 14.3592112, 'log pri brezovici']},
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "north denmark", "coordinates" : [56.26392, 9.501785, 'north denmark'] }
                    //here maybe problems
             ]
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "stjordal", "coordinates" : [63.46779719999999, 10.917596, 'stjordal'] }
             ]
        },
        {
            "country" : "finland",
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "uddevalla", "coordinates" : [58.3498003, 11.935649, 'uddevalla'] }
                //here maybe problems
             ]
        },
        {
            "country" : "peru",
            "cities" : [
                { "city_name" : "tumbes", "coordinates" : [-3.9338256, -80.54384499999999, 'tumbes'] }
             ]
        },
        {
            "country" : "ecuador",
            "cities" : [
                ...
                { "city_name" : "banos", "coordinates" : [-1.396389, -78.424722, 'banos']},
                ...
                { "city_name" : "cuenca", "coordinates" : [40.0703925, -2.1374162, 'cuenca'] }
             ]
        },
        {
            "country" : "italy",
            "cities" : [
                { "city_name" : "val daosta", "coordinates" : [45.7388878, 7.426186599999999, 'val daosta']},
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "reims", "coordinates" : [49.258329, 4.031696, 'reims']},
                { "city_name" : "cannes", "coordinates" : [43.552847, 7.017369, 'cannes']},
                { "city_name" : "paris", "coordinates" : [48.856614, 2.3522219, 'paris']},
                { "city_name" : "brest", "coordinates" : [48.390394, -4.486076, 'brest']},
                { "city_name" : "strasbourg", "coordinates" : [48.5734053, 7.752111299999999, 'strasbourg']},
                { "city_name" : "biarritz", "coordinates" : [43.4831519, -1.558626, 'biarritz']},
        ...
        },
        {
            "country" : "malaysia",
            "cities" : [
                { "city_name" : "palau redang", "coordinates" : [5.7844414, 103.0068926, 'palau redang']},
                // maybe problem
                { "city_name" : "kuala lumpur", "coordinates" : [3.139003, 101.686855, 'kuala lumpur']},
                { "city_name" : "melaka", "coordinates" : [2.189594, 102.2500868, 'melaka']},
        ...
        },
        {
            "country" : "cambodia",
            "cities" : [
                { "city_name" : "phnom penh", "coordinates" : [11.5448729, 104.8921668, 'phnom penh']},
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "south thailand", "coordinates" : [15.870032, 100.992541, 'south thailand'] }
             ]
        },
        {
            "country" : "ukraine",
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "galati", "coordinates" : [45.423333, 28.0425, 'galati'] }
             ]
        },
        {
            "country" : "turkey",
            "cities" : [
                { "city_name" : "turkey", "coordinates" : [38.963745, 35.243322, 'turkey'] }
             ]
        },
        {
            "country" : "serbia",
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "bideford", "coordinates" : [51.016684, -4.206666, 'bideford']},
                { "city_name" : "birmingham, uk", "coordinates" : [52.48624299999999, -1.890401, 'birmingham, uk']},
                { "city_name" : "gibraltar", "coordinates" : [36.140751, -5.353585, 'gibraltar'] }
            ]
        },
        {
            "country" : "austria",
        ...
        },
        {
            ...
            "cities" : [
                ...
                { "city_name" : "tunisia", "coordinates" : [33.886917, 9.537499, 'tunisia'] }
                // problems here
             ]
        },
        {
        ...
        },
        {
            "country" : "iceland",
            "cities" : [
                { "city_name" : "Reykjahlid", "coordinates" : [65.64361099999999, -16.908611, 'Reykjahlid'] }
             ]
        }
...
//functions for placing content into the html and content display
...
work.display = function() {
    for (var job = 0; work.jobs.length > job; job++) {
    ...
    $("#workExperience").after(formattedButton);
}

projects.display = function() {
    for (var project = 0; projects.projects.length > project; project++) {
...
education.display = function() {
    ...
    for (var course = 0;  course < education.courses.length; course++) {
...
// displa button and button functionality

$("#button-text").prepend("click on images to show or ");
...
// locationFinder() returns an array of every location from bio, education, and work.
...
// placenFinder() returns an array of every location from places
function placeFinder() {
    var locations = [];
    // iterates through school locations and appends each location to the locations array
    for (var place = 0; places.countries.length > place; place++) {
        for (var city = 0; places.countries[place].cities.length > city; city++) {
...
// make variables with location arrays
...
var map_places;
var mgr_places;
var bounds_places = new google.maps.LatLngBounds();
...
function initialize() {
    ...
    google.maps.event.addListener(mgr, "loaded", function() {
        // the data passed to the marker manager (is the array of) the coordinates of the locations
        for (var coordinate_pair = 0; coordinate_pair < coordinates.length; coordinate_pair++) {
            // console.log(coordinate_pair,coordinates[coordinate_pair][0], coordinates[coordinate_pair][1])
            //making size of map, depending on the markers
            var myLatLng = new google.maps.LatLng(coordinates[coordinate_pair][0], coordinates[coordinate_pair][1]);
    ...
    google.maps.event.addListener(mgr_places, "loaded", function() {
        for (var coordinate_pair = 0; coordinate_pair < places_coordinates.length; coordinate_pair++) {
            //console.log(coordinate_pair,places_coordinates[coordinate_pair][0], places_coordinates[coordinate_pair][1])
            var myLatLng_places = new google.maps.LatLng(places_coordinates[coordinate_pair][0], places_coordinates[coordinate_pair][1]);
                bounds_places.extend(myLatLng_places);
            var marker = new google.maps.Marker({
        ...
        mgr_places.refresh();
        map_places.fitBounds(bounds_places);
        // i think something is not working with this bounding when screen is small.
    });
}
//run the initalize function for maps on load of window
